...
node("maven") {
	...
	stage("checkout") {
		git branch: "master", url: "https://github.com/${params.GITHUB}/estafet-microservices-scrum-api-story"
	}
	...
	stage("execute the container tests") {
			withEnv(
				[	"STORY_API_JDBC_URL=jdbc:postgresql://postgresql.${project}.svc:5432/${project}-${microservice}", 
