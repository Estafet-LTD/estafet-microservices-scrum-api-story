...
create table STORY (STORY_ID int4 not null, DESCRIPTION varchar(255) not null, PROJECT_ID int4 not null, SPRINT_ID int4, status varchar(255), STORY_POINTS int4 not null, TITLE varchar(255) not null, primary key (STORY_ID));
create table TASK (TASK_ID int4 not null, DESCRIPTION varchar(255) not null, INITIAL_HOURS int4 not null, REMAINING_HOURS int4 not null, STATUS varchar(255) not null, TITLE varchar(255) not null, STORY_ID int4 not null, primary key (TASK_ID));
